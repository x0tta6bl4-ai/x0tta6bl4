...
from src.core.mape_k.mape_orchestrator import (
    HealingAction,
    HealingActionType,
    MAPEOrchestrator,
)
...
class UnifiedState:
    ...
    # Timestamps
    last_mape_update: datetime | None = None
    last_agent_sync: datetime | None = None
...
class AgentMAPEIntegrator:
    ...
    def __init__(
        self,
        mape_orchestrator: MAPEOrchestrator | None = None,
...
# Singleton instance
_integrator_instance: AgentMAPEIntegrator | None = None
