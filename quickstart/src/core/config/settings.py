...
class Settings(BaseSettings):
    ...
    # Cryptocurrency
    # ─────────────────────────────────────────
    usdt_trc20_wallet: str | None = Field(
        default=None, validation_alias="USDT_TRC20_WALLET"
    )
    ton_wallet: str | None = Field(default=None, validation_alias="TON_WALLET")
    tron_api_key: str | None = Field(default=None, validation_alias="TRON_API_KEY")
    ...
    rpc_url: str | None = Field(default=None, validation_alias="RPC_URL")
    ...
    bootstrap_nodes: str | None = Field(
    ...
    otel_jaeger_url: str | None = Field(
