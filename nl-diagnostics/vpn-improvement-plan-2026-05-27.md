...
```text
snapshot: nl-diagnostics/snapshots/20260528T034120Z
packet: nl-diagnostics/provider-incident-packets/provider-incident-packet-20260528T034120Z.md
...
fresh probe snapshot: nl-diagnostics/snapshots/20260528T034120Z
...
probe history trend: stable_no_probe_evidence across 11 snapshots
...
provider packet report: nl-diagnostics/provider-incident-packets/provider-incident-packet-20260528T034120Z.md
...
incident timeline status: event_count=22, latest_type=provider_watch
...
secondary selection packet command added: nl-diagnostics/build_secondary_exit_selection_packet.py
secondary selection packet report: nl-diagnostics/secondary-exit-selection-packet-2026-05-28.md
secondary selection packet status: selection_packet_ready_no_endpoint, primary=upcloud-fi-hel, backup=ovhcloud-pl-waw, may_create_endpoint_now=false
...
outside-in NL transport uptime status: stable_healthy, samples=24, bad_streak=0
...
local root cleanup plan status: manual_cleanup_plan_ready, estimated_reclaim_gib=3.24, cleanup_execute_allowed=false
...
readiness audit status: ready_local_with_future_blocks, ready_local=24, blocked_future_approval=4, watch=3, missing=0
