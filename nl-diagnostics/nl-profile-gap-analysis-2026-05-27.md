...
profile: `/mnt/projects/nl-diagnostics/nl-server-profile/20260527T053614Z`
...
|---|---|---|---|
| ghost-access | `/opt/ghost-access-bot/current/scripts/check_bot_user_chains.py` | `local_name_drift` | backup-20260410-090811/scripts/check_bot_user_chains.py |
| ghost-access | `/opt/ghost-access-bot/current/scripts/issue_offline_subscription.py` | `missing_local_source` | - |
...
| ghost-access | `/opt/ghost-access-bot/current/telegram_bot_simple.py` | `missing_local_source` | - |
...
| ghost-vpn | `/mnt/projects/src/network/ghost_vpn_protocol.py` | `missing_local_source` | - |
...
| mesh | `/opt/x0tta6bl4-mesh/scripts/build_runtime_state.py` | `missing_local_source` | - |
...
| mesh | `/opt/x0tta6bl4-mesh/scripts/monitor.py` | `missing_local_source` | - |
| mesh | `/opt/x0tta6bl4-mesh/scripts/profile_status_api.py` | `missing_local_source` | - |
...
| mesh | `/opt/x0tta6bl4-mesh/scripts/vps_build_runtime_state.py` | `missing_local_source` | - |
...
5. Before any future NL write, require: fresh read-only profile, x-ui db/config backup plan, rollback command, and explicit operator approval.
