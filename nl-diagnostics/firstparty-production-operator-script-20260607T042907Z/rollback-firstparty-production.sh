...
TRANSCRIPT_DIR=/mnt/projects/nl-diagnostics/firstparty-production-operator-transcripts/20260607T042906Z
mkdir -p "$TRANSCRIPT_DIR"
TRANSCRIPT="${TRANSCRIPT:-$TRANSCRIPT_DIR/rollback-execution-$(date -u +%Y%m%dT%H%M%SZ).jsonl}"
