# Provider Incident Packet, 2026-05-27T15:06:01.011335+00:00
...
snapshot: /mnt/projects/nl-diagnostics/snapshots/20260527T083246Z
snapshot_age_seconds: 23595
snapshot_stale: True
NL writes: 0
```
...
warnings: ['NL runtime recommended_action=switch_profile', 'profile_switch_policy=blocked_stale_snapshot']
```
...
tcp_connections: {'close_wait': 0, 'established': 8, 'fin_wait_2': 0}
```
