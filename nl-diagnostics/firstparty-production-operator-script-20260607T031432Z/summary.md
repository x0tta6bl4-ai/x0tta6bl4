...
generated_at: `2026-06-07T03:14:32Z`
ok: `false`
...
- apply: `/mnt/projects/nl-diagnostics/firstparty-production-operator-script-20260607T031432Z/apply-firstparty-production.sh`
- rollback: `/mnt/projects/nl-diagnostics/firstparty-production-operator-script-20260607T031432Z/rollback-firstparty-production.sh`
...
| `script_files_written_executable_private` | `false` |
...
- script_files_written_executable_private
