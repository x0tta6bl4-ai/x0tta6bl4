...
try:
    from src.edge.api import edge_shutdown, edge_startup
...
try:
    from src.event_sourcing.api import event_sourcing_shutdown, event_sourcing_startup
...
class OptimizationEngine:
    ...
    def __init__(self):
        self.mape_k_loop: MAPEKLoop | None = None
        self.parl_controller: PARLController | None = None
        self.fl_integration = None
        self.loop_task: asyncio.Task | None = None
        self.network_manager: MeshNetworkManager | None = None
