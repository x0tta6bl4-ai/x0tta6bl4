...
class RateLimitConfig:
    ...
    path_overrides: dict[str, "RateLimitConfig"] | None = None
...
class InMemoryRateLimiter:
    ...
    async def is_allowed(self, client_id: str, config_override: RateLimitConfig | None = None) -> tuple[bool, int | None]:
        """
