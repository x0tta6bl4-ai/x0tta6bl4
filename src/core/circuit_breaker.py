...
try:
    ...
    PROMETHEUS_AVAILABLE = all([
        CIRCUIT_STATE_GAUGE, CIRCUIT_REQUESTS_TOTAL,
        CIRCUIT_FAILURES_TOTAL, CIRCUIT_STATE_CHANGES_TOTAL,
...
class CircuitBreaker:
    ...
    async def call(self, func: Callable[..., T], *args, **kwargs) -> T:
        ...
        try:
            ...
            if PROMETHEUS_AVAILABLE:
                CIRCUIT_REQUESTS_TOTAL.labels(circuit_name=self.name, result="success").inc()
            ...
            if PROMETHEUS_AVAILABLE:
                CIRCUIT_REQUESTS_TOTAL.labels(circuit_name=self.name, result="failure").inc()
