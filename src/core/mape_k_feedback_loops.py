...
class FeedbackLoopManager:
    ...
    def signal_performance_degradation(self, cpu_usage: float,
                                      memory_usage: float,
    ...
    def signal_decision_quality(self, decision_id: str,
    ...
    def signal_anomaly_detection(self, true_positive: bool,
                                false_positive: bool,
    ...
    def signal_resource_pressure(self, resource_type: str,
    ...
    def get_signal_history(self, loop_type: Optional[FeedbackLoopType] = None,
    ...
    def get_action_history(self, loop_type: Optional[FeedbackLoopType] = None,
