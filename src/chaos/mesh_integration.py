...
class MeshChaosIntegration:
    ...
    def __init__(self, mesh_network=None, chaos_controller: Optional[ChaosController] = None):
    ...
    async def simulate_network_partition(self, partition_groups: List[List[str]], duration: int = 15):
    ...
    async def simulate_high_latency(self, target_nodes: List[str], latency_ms: int = 500, duration: int = 20):
