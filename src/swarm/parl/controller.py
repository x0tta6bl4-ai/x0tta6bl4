...
class PARLController:
    ...
    def __init__(self, max_workers: int = 100, max_parallel_steps: int = 1500):
        ...
        self.experience_buffer: deque[Experience] = deque(maxlen=self.config.experience_buffer_size)
        ...
        logger.info(f"PARLController created: {max_workers} workers, {max_parallel_steps} max steps")
