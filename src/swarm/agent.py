...
class Agent:
    ...
    async def _execute_route_optimization(self, payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _update_metrics(self) -> None:
        ...
        if total > 0:
            ...
            self.metrics["avg_execution_time_ms"] = (
                self.total_execution_time / total
            )
...
class SpecializedAgent(Agent):
    ...
    def _get_capabilities_for_specialization(self, specialization: str) -> List[AgentCapability]:
        ...
        capabilities_map = {
            ...
            "analysis": [
                ...
                AgentCapability(name="anomaly_detection", scope=CapabilityScope.NETWORK)
            ],
            "optimization": [
        ...
        return capabilities_map.get(specialization, [AgentCapability(name="task_execution")])
