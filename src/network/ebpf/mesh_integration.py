...
class EBPFTopologyIntegrator:
    ...
    async def _collect_metrics(self):
        ...
        self.metrics.set_gauge('mesh_packet_drops_total', stats.get('dropped_packets', 0))
        self.metrics.set_gauge('mesh_packets_forwarded_total', stats.get('forwarded_packets', 0))
