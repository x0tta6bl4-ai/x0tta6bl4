...
class EBPFMapReader:
    ...
    def read_map(self, map_id: Optional[int] = None, map_name: Optional[str] = None) -> Dict[str, Any]:
        """
            ...
            for entry in map_data['data']:
                if 'key' in entry and 'value' in entry:
                    ...
                    if isinstance(key, list):
                        ...
                        key_str = str(key)
                    counters[key_str] = int(value) if isinstance(value, (int, str)) else value
...
if __name__ == "__main__":
    ...
    parser.add_argument("--counters", type=str, default="packet_counters", help="Read counter map")
