...
from src.network.proxy_config_manager import (
    ProxyConfigManager,
...
from src.network.proxy_selection_algorithm import ProxySelectionAlgorithm, SelectionStrategy
from src.network.reputation_scoring import ReputationScoringSystem
from src.network.proxy_metrics_collector import ProxyMetricsCollector, create_default_collector
from src.network.proxy_auth_middleware import ProxyAuthMiddleware, create_auth_middleware
...
class ProxyOrchestrator:
    ...
    async def _on_config_change(self, config: ProxyInfrastructureConfig):
        ...
        if self.selection_algorithm:
            ...
            self.selection_algorithm.stability_weight = config.selection.stability_weight
            self.selection_algorithm.geographic_weight = config.selection.geographic_weight
