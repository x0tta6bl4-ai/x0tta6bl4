...
class FakeTLSTransport(ObfuscationTransport):
    ...
    def generate_client_hello(self) -> bytes:
        ...
        sni_ext = struct.pack("!HHBH", 0x0000, sni_len + 5, sni_len + 3, 0x00) + \
                  struct.pack("!H", sni_len) + self.sni
        extensions += sni_ext
