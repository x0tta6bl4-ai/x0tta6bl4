...
from .signed_gossip import SignedGossip, MessageType, SignedMessage
from .quorum_validation import QuorumValidator, CriticalEventType, CriticalEvent
...
class MeshByzantineProtection:
    ...
    def sign_beacon(
        ...
        message = self.signed_gossip.sign_message(
            MessageType.BEACON,
            payload
        )
    ...
    def is_node_quarantined(self, node_id: str) -> bool:
        ...
        return self.signed_gossip.is_quarantined(node_id) or node_id in self.quarantined_nodes
