...
class MeshDigitalTwin:
    ...
    def create_test_topology(self, num_nodes: int = 10, connectivity: float = 0.3) -> None:
        ...
        logger.info(f"Created test topology: {len(self.nodes)} nodes, {len(self.links)} links")
    ...
    def simulate_node_failure(
        self,
        node_id: str,
        failure_duration_seconds: float = 60.0
    ) -> SimulationResult:
        """
            ...
            for node_id in failed_nodes:
                ...
                for neighbor in neighbors:
                    if (neighbor not in failed_nodes and
                        ...
                        random.random() < propagation_probability):
...
class ChaosScenarioRunner:
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_connectivity": statistics.mean(r.connectivity_maintained for r in self.results)
        }
