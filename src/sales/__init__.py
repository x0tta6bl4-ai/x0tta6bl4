...
_LAZY_EXPORTS = {
    ...
    "PaidApiSettings": "src.sales.x402_paid_api",
    "create_app": "src.sales.x402_paid_api",
    "build_discovery_payload": "src.sales.x402_paid_api",
    "build_public_services": "src.sales.x402_paid_api",
    "build_x402_validate_report": "src.sales.x402_paid_api",
