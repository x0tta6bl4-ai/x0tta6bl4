...
class TronScanVerifier:
    ...
    def verify_payment(
        ...
        try:
            ...
            for tx in data["data"]:
                is_recent = datetime.now() - datetime.fromtimestamp(tx['block_timestamp'] / 1000) < timedelta(hours=24)
    ...
    def verify_payment(
        ...
        try:
            ...
            for tx in data["transactions"]:
                ...
                is_recent = datetime.now() - datetime.fromtimestamp(tx['utime']) < timedelta(hours=24)
                if not is_recent:
                    continue
