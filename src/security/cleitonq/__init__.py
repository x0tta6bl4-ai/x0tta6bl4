"""x0tMQ package: IETF draft specification reference implementation.

Components
----------
* frame.py       — MAVLink v2 frame codec (CRC-16-CCITT)
* chunk.py       — X0TMQ_CHUNK fragmentation / reassembly (MSG_ID 50000)
...
from .chunk import CleitonqChunker, X0TMQ_CHUNK_MSG_ID
