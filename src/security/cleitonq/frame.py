"""MAVLink v2 frame codec for CleitonQ transport layer.
...
CLEITONQ_CHUNK, CLEITONQ_SESSION_INIT, and CLEITONQ_SIGNED_CMD.
"""
...
class MavlinkV2Frame:
    """Wire-format MAVLink v2 frame for one CleitonQ payload.

    Header layout (MAVLink v2):
        [0]   STX (0xFD)
        [1]   payload_len
        [2]   incompat_flags (0x00 for CleitonQ)
        [3]   compat_flags
        [4]   seq
        [5]   sys_id
        [6]   comp_id
