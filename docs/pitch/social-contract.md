...
| 4 | Рабочая станция (Ryzen 9, 64 ГБ RAM, SSD 1 ТБ) | 1 шт. | 180 000 ₽ | **180 000 ₽** | Компиляция ядра Linux, сборка программ ядра, обучение моделей. Подробная сборка: pc-build.md |
...
| 6 | Облачный сервер VPS, 12 мес. | 12 мес. | 5 000 ₽/мес | **60 000 ₽** | Удалённая демонстрация продукта без выезда. Цена: reg.ru (тариф ~4 800-9 000 ₽/мес, среднее 5 000) |
| | **ИТОГО** | | | **~350 000 ₽** | |
