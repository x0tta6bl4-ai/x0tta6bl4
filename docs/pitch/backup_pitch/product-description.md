...
Стандартные алгоритмы шифрования станут уязвимы, когда появятся квантовые компьютеры. Продукт использует **постквантовую криптографию** — алгоритмы, устойчивые к взлому даже квантовым компьютером. Это общепризнанные мировые эталоны стойкости (FIPS 203/204/205).
...
- Устойчивость к перспективным квантовым атакам (ML-KEM-768 + ML-DSA-65)
...
| PQC стек | ML-KEM-768 + ML-DSA-65, чистый Python | ✅ Verified |
| eBPF dataplane | 142k PPS TX, 49k PPS RX | ✅ Attached |
...
| Спецификация протокола | IETF-style Internet-Draft | ✅ Published |
...
|:-----------|:-----------|
| ML-KEM-768 (FIPS 203) | Постквантовое согласование ключей |
| ML-DSA-65 (FIPS 204) | Постквантовая подпись команд |
| SPHINCS+ (FIPS 205) | Долгосрочная архивная подпись |
| eBPF/XDP | Обработка пакетов на уровне ядра Linux |
