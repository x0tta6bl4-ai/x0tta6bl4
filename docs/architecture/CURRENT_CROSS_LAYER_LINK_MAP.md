...
3. Lifecycle readiness map:
   ...
   - Next: extend the same readiness distinction to route-only modules that still lack explicit backing-state readiness, such as playbooks.
