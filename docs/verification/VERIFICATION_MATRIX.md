...
| **eBPF to x0tMQ PQC Pipeline** | `✅ VERIFIED` | [`src/network/ebpf/ebpf_to_x0tmq_bridge.py`](file:///mnt/projects/src/network/ebpf/ebpf_to_x0tmq_bridge.py) | `pytest tests/unit/network/ebpf/test_ebpf_to_x0tmq_bridge_unit.py` | eBPF telemetry streaming over x0tMQ PQC into MAPE-K PASS |
| **PQC SVID Certificate Rotator** | `✅ VERIFIED` | [`src/security/pqc_svid_rotator.py`](file:///mnt/projects/src/security/pqc_svid_rotator.py) | `pytest tests/unit/security/test_pqc_svid_rotator_unit.py` | Automated ML-DSA-65 PQC identity rotation aligned with SPIRE SVID PASS |
| **GraphSAGE GNN x0tMQ Integrator** | `✅ VERIFIED` | [`src/ml/graphsage_x0tmq_integrator.py`](file:///mnt/projects/src/ml/graphsage_x0tmq_integrator.py) | `pytest tests/unit/ml/test_graphsage_x0tmq_integrator_unit.py` | Real-time GNN topology anomaly classification over x0tMQ PQC PASS |
