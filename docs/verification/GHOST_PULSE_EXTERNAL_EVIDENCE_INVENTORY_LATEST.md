...
- verified: `packet_capture, baseline_timing_comparison, security_review`
- invalid: `kernel_attach, dpi_lab, whitelist_lab, production_readiness`
- missing: `none`
...
- expected_replacement_required: `kernel_attach, dpi_lab, whitelist_lab, production_readiness`

## Rows

| Claim | JSON | Markdown | Proof Status | Validation Status | SHA256 |
| --- | --- | --- | --- | --- | --- |
| kernel_attach | `docs/verification/GHOST_PULSE_KERNEL_ATTACH_LATEST.json` | `docs/verification/GHOST_PULSE_KERNEL_ATTACH_LATEST.md` | `INVALID` | `INVALID` | `fc8f77bed51825f468582a25cb1087cc00c89a739f880d1d1b0da7496751473d` |
