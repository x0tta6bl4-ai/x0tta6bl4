...
## 2026-02-08: Grant application — full package (Batch 5)

**Что:** Полный пакет документов для гранта Старт-ИИ-1.
**Файлы:**
- `plans/НИОКР_ОПИСАНИЕ_ДЛЯ_ГРАНТА.md` — 7 компонентов НИОКР, 5 пунктов научной новизны, сравнение с аналогами, план работ на 12 месяцев
- `docs/DEMO_SCRIPT.md` — 2-минутный демо-скрипт (5 шагов)
- `docs/FSI_CHECKLIST.md` — кросс-проверка по всем критериям ФСИ (все ГОТОВО)
- `docs/CLAIMS_AUDIT.md` — аудит 44 утверждений: 37 подтверждены, 4 косвенно, 3 уточнены
- `docs/COVERAGE_REPORT.md` — 188 тестов на 3878 строк НИОКР-кода
- `docs/BENCHMARK_OUTPUT.txt` — текстовый экспорт всех метрик
- `ACTION_PLAN_NOW.md` — все задачи закрыты, осталось видео + подача
**Коммиты:** `3f484429`, `b47539f7`, текущий
**Решения:**
- MTTD/MTTR/авторазрешение — уточнены как "проектные метрики" по рекомендации аудита
- Cascade failure recall 31.7% — честно указано как задача Этапа 2 НИОКР
- Coverage plugin зависает из-за torch — задокументировано, тесты проходят корректно
