...
from src.consensus.raft_consensus import RaftNode, RaftCluster, RaftState, LogEntry
...
def test_receive_append_entries_consistency():
    ...
    ok = follower.receive_append_entries(term=1, leader_id="l", prev_log_index=0, prev_log_term=0,
