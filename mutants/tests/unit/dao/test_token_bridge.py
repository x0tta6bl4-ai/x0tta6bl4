...
class TestTokenBridge(unittest.TestCase):
    ...
    def test_address_registration(self):
        ...
        self.bridge.register_address("node-1", "0xABCDEF1234567890ABCDEF1234567890ABCDEF12")
    ...
    def test_address_not_found(self):
        ...
        self.assertIsNone(self.bridge.get_node_id("0x0000000000000000000000000000000000000000"))
    ...
    def test_pending_txs(self):
        ...
        self.bridge._tx_history.append(BridgeTransaction(
            tx_id="tx1", direction=BridgeDirection.TO_CHAIN,
            from_address="", to_address="", amount=0,
            event_type="", timestamp=0, status="pending"
        ))
        self.bridge._tx_history.append(BridgeTransaction(
            tx_id="tx2", direction=BridgeDirection.TO_CHAIN,
            from_address="", to_address="", amount=0,
            event_type="", timestamp=0, status="confirmed"
        ))
...
class TestBridgeSyncLogic(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.bridge.register_address("node-1", "0x1111111111111111111111111111111111111111")
        self.bridge.register_address("node-2", "0x2222222222222222222222222222222222222222")
    
    def test_sync_stake_creates_balance(self):
        """Sync stake should create balance if needed."""
        # Run sync
        asyncio.run(self.bridge._sync_stake(
    ...
    def test_sync_transfer_mints_for_deposit(self):
        ...
        asyncio.run(self.bridge._sync_transfer(
...
class TestBridgeIntegration(unittest.TestCase):
    ...
    def test_full_sync_cycle(self):
        ...
        asyncio.run(bridge._sync_transfer(
        ...
        # Alice stakes
        asyncio.run(bridge._sync_stake(
