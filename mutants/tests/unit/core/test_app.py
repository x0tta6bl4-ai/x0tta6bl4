...
class TestAppEndpoints:
    ...
    def test_cast_vote_endpoint(self, mock_vote, client):
        ...
        assert "success" in str(data) or "message" in str(data) or "recorded" in data or "voting_power" in data
    ...
    def test_handshake_endpoint(self, mock_mtls, client):
        ...
        mock_mtls_controller_instance.verify_peer_spiffe_id = AsyncMock(return_value=True)
...
class TestAppStartupShutdown:
    ...
    async def test_startup_event(self):
        ...
        with patch('src.core.app.mesh_sync.start', new_callable=AsyncMock), \
    ...
    async def test_shutdown_event(self):
        ...
        with patch('src.core.app.mesh_sync.stop', new_callable=AsyncMock), \
