...
class TestCiliumIntegration:
    ...
    def test_get_flows(self):
        ...
        # Record some flows
        integration.record_flow(
            "10.0.0.1", "10.0.0.2", 8080, 9090, "TCP",
            FlowDirection.INGRESS, FlowVerdict.FORWARDED, 1024, 10
        )
        integration.record_flow(
            "10.0.0.3", "10.0.0.4", 8080, 9090, "UDP",
            FlowDirection.EGRESS, FlowVerdict.DROPPED, 512, 5
        )
