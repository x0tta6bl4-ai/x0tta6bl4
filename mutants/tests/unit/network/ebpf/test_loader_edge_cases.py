    ...
    def test_attach_mode_validation(self):
        ...
        try:
            ...
            with patch('pathlib.Path.exists', return_value=True), \
                ...
                with pytest.raises((TypeError, ValueError, KeyError, AttributeError, EBPFAttachError)):
    ...
    def test_bpftool_failure(self):
        ...
        try:
            ...
            if hasattr(loader, 'attach_kprobe'):
                with patch('subprocess.run', return_value=Mock(returncode=1, stderr="bpftool error")):
                    with pytest.raises((EBPFAttachError, AttributeError, NotImplementedError)):
