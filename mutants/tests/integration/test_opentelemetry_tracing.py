...
from src.monitoring.opentelemetry_tracing import (
    OTelTracingManager,
    MAPEKSpans,
    NetworkSpans,
    SPIFFESpans,
...
from src.monitoring.opentelemetry_extended import (
    LedgerSpans,
    DAOSpans,
    EBPFSpans,
...
@pytest.mark.parametrize("component_type", [
    "mapek", "network", "spiffe", "ml", "ledger", 
    "dao", "ebpf", "fl", "raft", "crdt", "contract"
])
