...
from src.ml.ensemble_anomaly_detector import (
    get_ensemble_detector, EnsembleVotingStrategy,
    IsolationForestDetector, LocalOutlierFactorDetector, IQRDetector, MovingAverageDetector
)
...
class TestEnsembleVotingAccuracy:
    ...
    def test_average_confidence_voting(self):
        ...
        detector = get_ensemble_detector(strategy=EnsembleVotingStrategy.AVERAGE_CONFIDENCE)
...
class TestSeverityClassification:
    ...
    def test_severity_classification_levels(self):
        ...
        for i in range(200):
            detector.record_metric("critical_endpoint", "response_time", 100.0 + (i % 5))
