...
class TestDynamicOptimizer:
    ...
    def test_healthy_state_optimization(self):
        ...
        opt = DynamicOptimizer()
        for _ in range(10):
            opt.record_performance(PerformanceMetrics(
                cpu_usage=40.0, memory_usage=50.0, cycle_latency=1.0,
                decisions_per_minute=40, decision_quality=0.9,
                anomaly_detection_accuracy=0.9, false_positive_rate=0.02
            ))
...
class TestFeedbackLoopManager:
    ...
    def test_loop_metrics(self):
        ...
        assert metrics[FeedbackLoopType.METRICS_LEARNING.value]['signals_processed'] >= 1
...
class TestIntegration:
    ...
    def test_self_learning_to_dynamic_optimization(self):
        ...
        metrics = PerformanceMetrics(
            cpu_usage=60.0, memory_usage=65.0, cycle_latency=1.5,
            decisions_per_minute=35, decision_quality=0.85,
            anomaly_detection_accuracy=0.8, false_positive_rate=0.08
        )
    ...
    def test_full_feedback_loop_cycle(self):
        ...
        dyn_opt.record_performance(PerformanceMetrics(
            cpu_usage=70.0, memory_usage=75.0, cycle_latency=2.0,
            decisions_per_minute=30, decision_quality=0.8,
            anomaly_detection_accuracy=0.75, false_positive_rate=0.1
        ))
