...
class TestMLIntegrationComplete:
    ...
    async def test_rag_anomaly_integration(self):
        ...
        normal_samples = [
            np.random.normal(0.5, 0.1, 4) for _ in range(100)
        ]
    ...
    async def test_decision_lora_integration(self):
        ...
        # Setup policies
        policies = [
            Policy("scale", "Scale Up", "Add replicas", PolicyPriority.HIGH, success_rate=0.8),
            Policy("optimize", "Optimize", "Tune config", PolicyPriority.MEDIUM, success_rate=0.7),
            Policy("restart", "Restart", "Restart service", PolicyPriority.CRITICAL, success_rate=0.6),
        ]
