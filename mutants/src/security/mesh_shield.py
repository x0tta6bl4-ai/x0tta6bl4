...
class MeshShield:
    ...
    def _analyze_threat(self, node_id: str) -> ThreatLevel:
        ...
        # Count by type
        anomaly_scores = [i.value for i in recent if i.indicator_type == "anomaly_score"]
    ...
    def _determine_reason(self, indicator: ThreatIndicator) -> QuarantineReason:
        ...
        return type_to_reason.get(indicator.indicator_type, QuarantineReason.ANOMALY_SCORE)
    ...
    def release_node(self, node_id: str, reason: str = "investigation_complete") -> bool:
        """
    ...
    def list_quarantined(self) -> List[QuarantineRecord]:
        ...
        now = datetime.now()
        expired = [
            nid for nid, r in self._quarantined.items()
    ...
    def get_metrics(self) -> Dict:
        ...
        avg_mttr = (
            ...
            if self._metrics["mttr_count"] > 0 else 0
        )
        return {
            ...
            "false_positive_rate": (
                ...
                if self._metrics["releases_total"] > 0 else 0
            ),
