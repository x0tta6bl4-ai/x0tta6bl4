...
class ThreatDetector:
    ...
    def _determine_severity(
        ...
        # High severity
        if threat_type in [ThreatType.UNAUTHORIZED_ACCESS, ThreatType.DENIAL_OF_SERVICE]:
            if confidence > 0.7:
    ...
    def get_threat_statistics(
        ...
        threats = self.get_threats(start_time=start_time, end_time=end_time, limit=10000)
