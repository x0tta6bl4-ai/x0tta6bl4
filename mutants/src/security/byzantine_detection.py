...
class NodeReputation:
    ...
    def update_reputation(self, success: bool):
        ...
        if self.total_interactions > 0:
            ...
            ) * (0.9 ** self.byzantine_violations)  # Exponential decay on violations
...
class ByzantineDetector:
    ...
    def __init__(
        ...
        self.consensus_history: Dict[int, Dict[str, Any]] = {}  # round -> consensus data
    ...
    def detect_byzantine_behavior(
        ...
        if reported_by:
            ...
            similar_alerts = [
                ...
                a.behavior_type == behavior_type and
                (time.time() - a.timestamp.timestamp()) < 300  # Within 5 minutes
            ]
            ...
            if len(similar_alerts) >= self.min_evidence_nodes - 1:
                ...
                alert.reported_by = [a.reported_by[0] for a in similar_alerts if a.reported_by] + [reported_by]
            ...
            if proposed_value != majority_value:
                ...
                alert = self.detect_byzantine_behavior(
                    ...
                    evidence={
                        ...
                        "consensus_round": consensus_round,
                        "value_distribution": {str(k): len(v) for k, v in value_counts.items()}
                    },
                    consensus_round=consensus_round
                )
                return False, alert
