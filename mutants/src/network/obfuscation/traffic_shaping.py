...
class TrafficShaper:
    ...
    def shape_packet(self, data: bytes) -> bytes:
        ...
        if self.params.pad_to_size:
            ...
            suitable_sizes = [s for s in self.params.typical_packet_sizes if s >= original_size]
            if suitable_sizes:
        ...
        if original_size < target_size:
            ...
            padding = bytes([random.randint(0, 255) for _ in range(target_size - original_size)])
    ...
    def get_profile_info(self) -> dict:
        ...
        return {
            ...
            "timing_range_ms": [self.params.min_interval_ms, self.params.max_interval_ms],
...
class TrafficAnalyzer:
    ...
    def get_statistics(self) -> dict:
        ...
        avg_interval = sum(self.inter_arrival_times) / len(self.inter_arrival_times) if self.inter_arrival_times else 0
