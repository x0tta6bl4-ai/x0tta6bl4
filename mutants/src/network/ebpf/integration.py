...
class EBPFProgramIntegration:
    ...
    def register_ebpf_program(self, program_id: str, program_type: str, metrics_callback=None):
    ...
    def _metric_to_event(self, metric: Dict[str, Any], program_id: str) -> Optional[EBPFEvent]:
