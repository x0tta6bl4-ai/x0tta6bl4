...
stego_encode_total = Counter(
    'stego_encode_total',
    'Total number of stego-mesh encodings',
    ['protocol']
)

stego_decode_total = Counter(
    'stego_decode_total',
    'Total number of stego-mesh decodings',
    ['protocol']
)
...
stego_overhead = Histogram(
    'stego_overhead_bytes',
    'Overhead of stego-mesh encoding',
    ['protocol']
)
...
digital_twins_nodes = Gauge(
    'digital_twins_nodes_total',
    'Total number of digital twin nodes'
)

# Метрики Federated Learning
fl_round_total = Counter(
    'fl_round_total',
...
audit_trail_size = Gauge(
    'audit_trail_size_total',
    'Total number of records in audit trail'
)
...
v3_info = Info(
    'v3_components',
    'Information about V3.0 components'
)
