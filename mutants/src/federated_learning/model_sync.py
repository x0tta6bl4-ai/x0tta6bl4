...
class ModelSynchronizer:
    ...
    def receive_global_model(
        ...
        try:
            ...
            # Check version
            if self.current_model and global_model.version <= self.current_model.version:
                logger.warning(
    ...
    def resolve_conflicts(
        ...
        logger.warning(f"Resolving {len(conflicts)} conflicts using strategy: {strategy}")
