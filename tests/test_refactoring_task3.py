...
class TestByzantineRefactoring:
    ...
    def test_validate_prerequisites_success(self):
        ...
        from src.federated_learning.byzantine_refactored import \
            ByzantineRefactored

        detector = ByzantineRefactored(f=1)
        updates = [MockUpdate(f"node{i}", [0.1 * i, 0.2 * i], 10) for i in range(5)]
    ...
    def test_aggregate_basic(self):
        ...
        updates = [
            MockUpdate(f"node{i}", [0.1 * i for _ in range(3)], 10) for i in range(5)
        ]
    ...
    def test_aggregate_multi_krum(self):
        ...
        updates = [MockUpdate(f"node{i}", [float(i)] * 3, 10) for i in range(5)]
...
class TestRaftLogValidator:
    ...
    def test_is_log_consistent_valid(self):
        ...
        from src.consensus.raft_refactored import LogEntry, RaftLogValidator
...
class TestIntegration:
    ...
    def test_byzantine_aggregation_with_byzantine_nodes(self):
        ...
        updates = [MockUpdate(f"node{i}", [0.1 * i] * 5, 100) for i in range(7)]
