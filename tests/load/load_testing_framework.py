...
class LoadTestResults:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "actual_throughput_ops_per_sec": (
                self.total_iterations / self.total_time if self.total_time > 0 else 0
            ),
            "total_errors": self.errors,
            "error_rate": (
                self.errors / self.total_iterations if self.total_iterations > 0 else 0
            ),
            "latency_stats": {
...
class LoadTester:
    ...
    async def generate_test_load(self, async_func, *args, **kwargs) -> LoadTestResults:
        """
    ...
    def print_results(self, results: LoadTestResults):
        ...
        print(
            f"Actual Throughput: {stats['actual_throughput_ops_per_sec']:.1f} ops/sec"
        )
...
class StressTester:
    ...
    async def run_stress_test(self, async_func, *args, **kwargs) -> Dict[str, Any]:
        """
