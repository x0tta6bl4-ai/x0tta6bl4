...
class TestPerformanceGains:
    ...
    def test_cache_hit_performance(self, cache_session):
        ...
        assert avg_per_lookup < 0.000001, f"Cache lookup took {avg_per_lookup*1e6:.3f}µs"
...
class TestIntegration:
    ...
    def test_combined_performance(self, db_session, cache_session, ml_models_session, 
                                  app_session, config_session, performance_tracker):
