...
try:
    from src.self_healing.graphsage_causal_integration import (
        ...
        create_graphsage_causal_integration
    )
...
class TestGraphSAGECausalIntegration:
    ...
    def test_detect_with_root_cause_anomaly(self, integration):
        ...
        if prediction.is_anomaly:
            ...
            assert causal_result is not None or root_cause is None  # May or may not have root cause
...
class TestEndToEndWorkflow:
    ...
    def test_complete_workflow(self, mapek_analyzer):
        ...
        assert 'CPU' in analysis_result or 'cpu' in analysis_result.lower() or 'Anomaly' in analysis_result
