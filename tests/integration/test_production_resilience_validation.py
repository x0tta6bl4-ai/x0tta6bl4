...
from src.resilience.advanced_patterns import (
    ...
    RetryStrategy, BulkheadIsolation, FallbackHandler
)
...
class TestAnomalyDetectionResilience:
    ...
    def test_hybrid_detection_modes(self):
        ...
        for mode in [HybridDetectionMode.PRODUCTION_ONLY, 
...
class TestPerformanceBenchmarks:
    ...
    def test_edge_validator_boundary_checking_speed(self):
        ...
        violation_count = 0
        for i in range(500):
            violations = validator.check_numeric_bounds(float(i), min_val=0, max_val=250)
            if violations:
                violation_count += 1
