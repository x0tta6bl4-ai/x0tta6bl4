...
class TestVaultSecretManager:
    ...
    async def test_store_database_credentials(
    ...
    async def test_store_api_credentials(
        self, secret_manager, mock_hvac_client
    ):
    ...
    async def test_get_proxy_credentials(
        self, secret_manager, mock_hvac_client
    ):
    ...
    async def test_rotate_proxy_credentials(
        self, secret_manager, mock_hvac_client
    ):
    ...
    async def test_store_tls_certificate(
        self, secret_manager, mock_hvac_client
    ):
    ...
    async def test_list_secrets_error(
        ...
        mock_hvac_client.secrets.kv.v2.list_secrets.side_effect = Exception("Vault error")
