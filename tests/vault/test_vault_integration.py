...
from src.security.vault_secrets import VaultSecretManager, SecretInjector
...
class TestVaultErrorHandling:
    ...
    async def test_graceful_degradation_on_vault_unavailable(
        ...
        mock_hvac_client.secrets.kv.v2.read_secret_version.side_effect = Exception("Connection refused")
    ...
    async def test_recovery_after_vault_restored(
        ...
        result = await authenticated_vault_client.get_secret('proxy/test', use_cache=False)
