...
class TestReplayAttacks:
    ...
    def test_beacon_replay_attack(self):
        ...
        # Sign beacon
        beacon1 = gossip1.sign_message(MessageType.BEACON, {"neighbors": ["node-2"]})
    ...
    def test_epoch_replay_attack(self):
        ...
        msg1 = gossip1.sign_message(MessageType.BEACON, {"neighbors": ["node-2"]})
...
class TestFalseFailureReports:
    ...
    def test_single_false_report_rejected(self):
        ...
        signature = (
            protections["node-1"]
            .signed_gossip.sign_message(MessageType.NODE_FAILURE, {"target": "node-5"})
            .signature
        )
    ...
    def test_quorum_prevents_false_reports(self):
        ...
        event = protections["node-1"].report_node_failure(
            "node-5", evidence={"latency": 1000.0}  # False
        )
