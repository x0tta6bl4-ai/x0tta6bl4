...
class TestOrchestratorLifecycle:
    ...
    async def test_start_success(self):
        ...
        with patch.object(orchestrator, '_initialize_components', new_callable=AsyncMock):
            with patch.object(orchestrator, '_load_programs', new_callable=AsyncMock):
                with patch.object(orchestrator, '_start_background_tasks', new_callable=AsyncMock):
    ...
    async def test_stop_success(self):
        ...
        with patch.object(orchestrator, '_stop_background_tasks', new_callable=AsyncMock):
            with patch.object(orchestrator, '_cleanup_components', new_callable=AsyncMock):
