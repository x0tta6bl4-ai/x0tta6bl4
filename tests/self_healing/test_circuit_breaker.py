...
class TestCircuitBreakerStates:
    ...
    @pytest.mark.asyncio
    async def test_closed_to_open_on_threshold(self, circuit_breaker, async_always_fail):
    ...
    @pytest.mark.asyncio
    async def test_open_rejects_calls(self, circuit_breaker, async_always_fail, async_always_succeed):
    ...
    @pytest.mark.asyncio
    async def test_open_to_half_open_after_timeout(self, fast_circuit_breaker, async_always_fail, async_always_succeed):
    ...
    @pytest.mark.asyncio
    async def test_half_open_to_closed_on_success(self, circuit_breaker, async_always_fail, async_always_succeed):
    ...
    @pytest.mark.asyncio
    async def test_half_open_to_open_on_failure(self, circuit_breaker, async_always_fail):
    ...
    @pytest.mark.asyncio
    async def test_half_open_limits_concurrent_calls(self, circuit_breaker, async_always_succeed):
...
class TestCircuitBreakerFallback:
    ...
    @pytest.mark.asyncio
    async def test_fallback_called_when_open(self, circuit_breaker_with_fallback, async_always_fail):
    ...
    @pytest.mark.asyncio
    async def test_fallback_called_on_failure_in_closed(self, circuit_breaker_with_fallback, async_always_fail):
    ...
    @pytest.mark.asyncio
    async def test_no_fallback_raises_exception(self, circuit_breaker, async_always_fail):
...
class TestCircuitBreakerMetrics:
    ...
    @pytest.mark.asyncio
    async def test_success_metrics_recorded(self, circuit_breaker, async_always_succeed):
    ...
    @pytest.mark.asyncio
    async def test_metrics_state_reflects_circuit_state(self, circuit_breaker, async_always_fail):
    ...
    @pytest.mark.asyncio
    async def test_success_resets_failure_count(self, circuit_breaker, async_always_succeed, async_always_fail):
...
class TestCircuitBreakerTiming:
    ...
    @pytest.mark.asyncio
    async def test_should_attempt_reset_respects_timeout(self, fast_circuit_breaker, async_always_fail):
