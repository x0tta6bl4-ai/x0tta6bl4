...
@pytest.mark.skipif(
    not BYZANTINE_ROBUST_AVAILABLE, reason="Byzantine-robust aggregators not available"
)
...
class TestAdaptiveTrimmedMeanAggregator:
    ...
    def test_outlier_detection(self):
        ...
        aggregator = AdaptiveTrimmedMeanAggregator(beta=0.1, outlier_detection="iqr")
