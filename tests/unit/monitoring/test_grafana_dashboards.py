...
try:
    from src.monitoring.grafana_dashboards import (
        GrafanaDashboardBuilder, GrafanaPanel,
        create_grafana_provisioning_config, create_ml_pipeline_dashboard,
        create_network_mesh_dashboard, create_security_dashboard,
        create_system_health_dashboard, create_tracing_dashboard,
...
class TestGrafanaDashboardBuilder:
    ...
    def test_builder_initialization(self):
        ...
        builder = GrafanaDashboardBuilder(
            title="Test Dashboard", uid="test_uid", description="Test description"
        )
    ...
    def test_add_time_series(self):
        ...
        builder.add_time_series(
            "Network I/O", [{"expr": "network_bytes", "refId": "A"}]
        )
    ...
    def test_builder_chainable(self):
        ...
        dashboard = (
            GrafanaDashboardBuilder("Test", "test")
            .add_row("Row 1")
