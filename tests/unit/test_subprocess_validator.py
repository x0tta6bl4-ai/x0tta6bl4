...
"""
import pytest
from src.core.subprocess_validator import validate_command, validate_arguments, safe_run
...
def test_safe_run_with_validation():
    ...
    assert result.returncode == 0 or result.returncode == 1  # May or may not find python3
