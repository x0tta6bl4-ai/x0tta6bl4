...
import libx0t.network.vpn_leak_protection as mod
...
async def test_webrtc_leak_paths(monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "libx0t.network.webrtc_leak_fix", fake_module)
    ...
    monkeypatch.setitem(
        sys.modules,
        "libx0t.network.webrtc_leak_fix",
