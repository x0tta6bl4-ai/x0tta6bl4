...
try:
    ...
    try:
        from src.security.policy_engine import PolicyAction, PolicyEngine
...
@pytest.mark.skipif(
    not ZERO_TRUST_AVAILABLE, reason="Zero Trust Policy Engine not available"
)
...
class TestZeroTrustPerformance:
    ...
    def test_large_policy_set(self):
        ...
        decision = engine.evaluate(
            peer_spiffe_id="spiffe://test/workload/user-500", resource="resource-500"
        )
