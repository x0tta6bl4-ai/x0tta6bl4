...
class TestMeshMTLSEnforcer:
    ...
    def test_enforcer_initialization(self, mock_spiffe_controller, mock_mtls_controller):
        """Test that enforcer initializes correctly."""
        with patch('src.security.mesh_mtls_enforcer.SPIFFEController', return_value=mock_spiffe_controller):
            with patch('src.security.mesh_mtls_enforcer.MTLSControllerProduction', return_value=mock_mtls_controller):
    ...
    def test_tls13_enforcement_check(self, mock_spiffe_controller, mock_mtls_controller):
    ...
    def test_tls13_enforcement_failure(self, mock_spiffe_controller, mock_mtls_controller):
    ...
    def test_tls13_enforcement_disabled(self, mock_spiffe_controller, mock_mtls_controller):
    ...
    def test_certificate_chain_validation(self, mock_spiffe_controller, mock_mtls_controller):
    ...
    def test_svid_verification_disabled(self, mock_spiffe_controller, mock_mtls_controller):
    ...
    def test_secure_client_setup_requires_init(self, mock_spiffe_controller, mock_mtls_controller):
...
class TestTLS13Requirements:
    ...
    def test_cipher_suite_requirements(self, mock_spiffe_controller, mock_mtls_controller):
...
class TestMTLSConnectivity:
    ...
    def test_connectivity_verification_setup(self, mock_spiffe_controller, mock_mtls_controller):
