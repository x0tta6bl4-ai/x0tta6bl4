...
try:
    from src.security.zero_trust.enforcement import (EnforcementResult,
                                                     TrustScore,
                                                     ZeroTrustEnforcer,
...
class TestZeroTrustEnforcer:
    ...
    def enforcer(self):
        ...
        with (
            patch("src.security.zero_trust.enforcement.ZeroTrustValidator"),
    ...
    def test_enforce_allow(self, enforcer):
        ...
        with patch.object(
            enforcer, "_calculate_trust_score", return_value=TrustScore.HIGH
        ):
...
class TestEnforcementResult:
    ...
    def test_enforcement_result_creation(self):
        ...
        result = EnforcementResult(
            allowed=True, trust_score=TrustScore.HIGH, reason="Access granted"
        )
