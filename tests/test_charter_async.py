...
@pytest.mark.skip(reason="Module src.westworld not implemented yet")
...
class TestViolationEscalation:
    ...
    def test_different_metrics_tracked_separately(self, enforcer_dev):
        ...
        user_location_violations = [
            v for v in violations if v["metric_name"] == "user_location"
        ]
