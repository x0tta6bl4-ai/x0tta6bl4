...
import pytest
import bcrypt
from src.security.password_migration import (
    PasswordMigrator,
    MigrationStats,
...
class TestPasswordVerification:
    ...
    def test_verify_non_bcrypt_rejected(self):
        ...
        assert migrator.verify_password("password", "5f4dcc3b5aa765d61d8327deb882cf99") is False
...
class TestMD5Detection:
    ...
    def test_is_md5_hash_valid(self):
        ...
        assert migrator.is_md5_hash("d41d8cd98f00b204e9800998ecf8427e") is True  # empty string MD5
...
class TestMD5Migration:
    ...
    def test_verify_legacy_or_bcrypt_forces_reset(self):
        ...
        is_valid, needs_rehashing = migrator.verify_legacy_or_bcrypt("password", md5_hash)
    ...
    def test_verify_legacy_or_bcrypt_bcrypt_works(self):
        ...
        is_valid, needs_rehashing = migrator.verify_legacy_or_bcrypt(password, bcrypt_hash)
