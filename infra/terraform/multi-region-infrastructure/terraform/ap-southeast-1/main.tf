# Terraform конфигурация для региона ap-southeast-1 (Азия-Пасифик)
...
module "vpc" {
  ...
  public_subnets = {
    "ap-southeast-1a" = { cidr = "10.30.1.0/24", az = "ap-southeast-1a" }
    "ap-southeast-1b" = { cidr = "10.30.2.0/24", az = "ap-southeast-1b" }
    "ap-southeast-1c" = { cidr = "10.30.3.0/24", az = "ap-southeast-1c" }
  }

  private_subnets = {
    "ap-southeast-1a" = { cidr = "10.30.10.0/24", az = "ap-southeast-1a" }
    "ap-southeast-1b" = { cidr = "10.30.11.0/24", az = "ap-southeast-1b" }
    "ap-southeast-1c" = { cidr = "10.30.12.0/24", az = "ap-southeast-1c" }
  }

  database_subnets = {
    "ap-southeast-1a" = { cidr = "10.30.20.0/24", az = "ap-southeast-1a" }
    "ap-southeast-1b" = { cidr = "10.30.21.0/24", az = "ap-southeast-1b" }
    "ap-southeast-1c" = { cidr = "10.30.22.0/24", az = "ap-southeast-1c" }
  }
...
module "eks" {
  ...
  eks_managed_node_groups = {
    main = {
      ...
      instance_types = [var.regional_config.ap_southeast_1.instance_types.eks]
      min_size       = 2
      max_size       = 10
      desired_size   = 3
...
module "rds" {
  ...
  instance_class = var.regional_config.ap_southeast_1.instance_types.rds
