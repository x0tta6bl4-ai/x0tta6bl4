...
class MetricsCollector:
                        ...
                        if len(parts) >= 2:
                            ...
                            try:
                                ...
                                if 'error_rate' in metric_name:
                                    ...
                                    metrics["resources"]["memory_mb"] = value / 1024 / 1024
    ...
    async def collect_continuous(self, duration_minutes: int = 60, interval_seconds: int = 10):
        """
        ...
        # Save metrics
        metrics_file = project_root / f"metrics_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
