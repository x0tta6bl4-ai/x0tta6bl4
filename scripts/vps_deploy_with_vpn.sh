#!/bin/bash
# VPS Deployment Script for x0tta6bl4 (with existing VPN)
# Deploys to VPS that already has VPN running
...
if [ -z "$VPS_IP" ]; then
    ...
    log_error "Example: $0 89.125.1.107 root example.com"
    exit 1
fi

echo "╔══════════════════════════════════════════════════════════════╗"
echo "║                                                              ║"
echo "║     🚀 VPS DEPLOYMENT (with existing VPN) - x0tta6bl4       ║"
echo "║                                                              ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
log_warn "⚠️  Detected existing VPN on this VPS"
log_info "Will use different ports to avoid conflicts"
echo ""

# Ports configuration (avoiding VPN ports)
APP_PORT=8080
METRICS_PORT=9090
NGINX_PORT=80
...
scp scripts/vps_setup_with_vpn.sh $VPS_USER@$VPS_IP:/root/
scp scripts/vps_docker_compose_with_vpn.yml $VPS_USER@$VPS_IP:/root/docker-compose-x0tta6bl4.yml
...
# Step 3: Setup on VPS
log_step "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
log_step "STEP 3: Setting up on VPS (preserving VPN)"
log_step "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"

log_info "Running setup script on VPS..."
ssh $VPS_USER@$VPS_IP "bash /root/vps_setup_with_vpn.sh $DOMAIN $APP_PORT"

log_info "✅ VPS setup complete (VPN preserved)"
echo ""
...
log_info "   $APP_URL"
log_info "   Direct: http://$VPS_IP:$APP_PORT"
echo ""
log_info "🔒 VPN is preserved and running on original ports"
echo ""
...
echo ""
log_info "🎆 CONGRATULATIONS! x0tta6bl4 is LIVE alongside your VPN! 🎆"
