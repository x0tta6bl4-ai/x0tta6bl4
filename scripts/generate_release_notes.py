...
def format_release_notes(version, categories):
    ...
    for category, commits in categories.items():
        ...
        for subject, commit_hash in commits:
            ...
            subject = re.sub(r'^(feat|fix|perf|security|refactor|docs|style|test)(\(.+\))?:\s*', '', subject)
            notes.append(f"- {subject} ([{commit_hash}](https://github.com/x0tta6bl4/x0tta6bl4/commit/{commit_hash}))")
        notes.append("")
