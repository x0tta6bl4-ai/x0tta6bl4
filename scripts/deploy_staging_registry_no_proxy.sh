#!/bin/bash
# Deployment script for staging environment from local registry without proxy
# Usage: ./scripts/deploy_staging_registry_no_proxy.sh [version]
...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║     Staging Deployment Script (Local Registry, No Proxy)      ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
