...
class MeshNodeDeployment:
    ...
    async def scale_to_nodes(self, target_count: int, base_host: str = "node") -> List[Dict]:
        """
...
async def main():
    ...
    parser.add_argument("--count", type=int, default=50, help="Number of nodes to deploy")
    parser.add_argument("--batch-size", type=int, default=10, help="Batch size for deployment")
