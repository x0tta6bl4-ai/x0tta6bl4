							...
							<div>
								<div class="content-style-form content-style-form-1">
									...
									?>
										...
										?>
										<p><label>Email</label><input type="email" class="input-block-level"name="txtemail" autofocus></p>
										<p><label>Пароль</label><input type="password" class="input-block-level"name="txtupass"></p>
								...
								<div class="content-style-form content-style-form-2">
									...
									<h2>Регистрация</h2>
									 <form class="pure-form" method="post">
										...
										<p><label>Email</label><input type="email" class="email" name="email" autofocus></p>
										<p><em class='result_password'></em></p>
										<p><label>Ваше имя</label><input type="text" name="name"></p>
										<p><label>Пароль</label><input class='password' name="password" type="password"></p>
										<p><button class="btn btn-large btn-primary" type="submit">Отправить</button></p>
