							...
							<div id="sorting">
								<ul id="option_list">
									...
									<li>
										...
										<ul id="sorting_list">
											<li><a href="search_cat.php?<?php echo $catlink; ?>&sort=price_asc">От дешевых к дорогим</a></li>
											<li><a href="search_cat.php?<?php echo $catlink; ?>&sort=price_desc">От дорогих к дешевым</a></li>
										</ul>
									</li>
								</ul>
								</div>
							<?php
								include("include/cat_grid.php");
