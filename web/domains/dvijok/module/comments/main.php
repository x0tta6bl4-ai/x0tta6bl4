<?php
	function Comments() {
		...
		if ($_SESSION['USER_LOGIN_IN'] != 1) echo 'Оставлять комментарии могут только зарегистрированные пользователи';
		else echo '
		...
		while ($Row = mysqli_fetch_assoc($Result)) {
			...
			echo '<div class="ChatBlock"><span>'.$Row['added'].' | '.$Row['date'].'</span>'.$Row['text'].$Admin.'</div>';
		}
	}
?>