;(function(document, window, undefined) {
  // wrap always your modules to avoid the namespace pollution
	...
	var $ = document.querySelectorAll.bind(document),
		...
		selectsArr = [{
			inputs: $('form.ac-cross input[type="checkbox"]'),
			type: 'cross'
		}, {
			inputs: $('form.ac-fill input[type="radio"]'),
			type: 'fill'
		}, {
			inputs: $('form.ac-checkmark input[type="checkbox"]'),
			type: 'checkmark'
		}, {
			inputs: $('form.ac-circle input[type="radio"]'),
			type: 'circle'
		}, {
			inputs: $('form.ac-boxfill input[type="checkbox"]'),
			type: 'boxfill'
		}, {
			inputs: $('form.ac-swirl input[type="radio"]'),
			type: 'swirl'
		}, {
			inputs: $('form.ac-diagonal input[type="checkbox"]'),
			type: 'diagonal'
		}, {
			inputs: $('form.ac-list input[type="checkbox"]'),
			type: 'list',
			svgDef: {
				viewBox: '0 0 300 100',
