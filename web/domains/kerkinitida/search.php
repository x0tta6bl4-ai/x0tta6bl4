							...
							<div id="sorting">
								<ul id="option_list">
									...
									?><span class="icon icon-arrow-right"></span></a>
										<ul id="sorting_list">
											<li><a href="search_cat.php?sort=price_asc">От дешевых к дорогим</a></li>
											<li><a href="search_cat.php?sort=price_desc">От дорогих к дешевым</a></li>
									</li>
								</ul>
								</div>
							<?php
								include("include/search_grid.php");
								include("include/search_list.php");
							?>
						</div>
