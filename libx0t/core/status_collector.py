...
_DEFAULT_VERSION = os.getenv("X0TTA6BL4_VERSION", "3.2.1")
...
class SystemMetricsCollector:
    ...
    def get_network_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            packets_in_per_sec = (
                (net_io.packets_recv - self._last_net_io.packets_recv) / time_delta
                if time_delta > 0
                else 0
            )
            packets_out_per_sec = (
                (net_io.packets_sent - self._last_net_io.packets_sent) / time_delta
                if time_delta > 0
                else 0
            )
            ...
            if hasattr(net_io, "dropin") and hasattr(net_io, "dropout"):
                ...
                packet_loss = (
                    (net_io.dropin / total_packets_in * 100)
