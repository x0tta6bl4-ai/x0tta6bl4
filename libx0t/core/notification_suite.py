#!/usr/bin/env python3
"""
notification_suite.py (renamed from notification-suite.py for valid Python import)
...
Examples:
  python3 notification_suite.py email -s "Subject" -b "Body" -t "a@b.com,c@d.com" --smtp-host localhost --smtp-port 25
  python3 notification_suite.py slack -w https://hooks.slack.com/services/XXX/YYY/ZZZ -m "Hello"
  python3 notification_suite.py watch -n mtls-demo -l "app=service-a,app=service-b" --timeout 600 --interval 10
